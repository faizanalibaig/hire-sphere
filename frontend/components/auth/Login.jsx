...
function Login() {
  return (
    <section className='h-[90%] flex flex-col justify-center items-center font-sans gap-8'>
      <h1 className='text-2xl font-bold'>Log in to Your Account</h1>
      <form className='flex flex-col gap-2'>
        <input
          type='text'
          placeholder='Enter your Email'
          className='border-2 border-[#CBD5E1]/20 w-[26rem] p-3 rounded-lg bg-[#FAFAF7] placeholder:text-[#5C626C] font-medium outline-none'
        />
        <input
          type='text'
